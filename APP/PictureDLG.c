...
static const GUI_WIDGET_CREATE_INFO _aDialogCreate[] = {
  ...
  { BUTTON_CreateIndirect, "<<", ID_BUTTON_0, 3, 277, 50, 20, 0, 0x00, 0 },
  { BUTTON_CreateIndirect, "--", ID_BUTTON_1, 62, 277, 50, 20, 0, 0x00, 0 },
  { BUTTON_CreateIndirect, "++", ID_BUTTON_2, 120, 277, 50, 20, 0, 0x00, 0 },
  { BUTTON_CreateIndirect, ">>", ID_BUTTON_3, 177, 277, 50, 20, 0, 0x00, 0 },
...
//	TREEVIEW_ITEM_Handle   hTreeItemSel;
	...
	FRAMEWIN_SetText(hItem,pathbuff);                                                  //显示路径
	strcpy(pathbuffx,pathbuff);
	return hTreeItemSel;
}
...
static void _cbDialog(WM_MESSAGE * pMsg) {
  ...
  switch (pMsg->MsgId) {
	...
	FRAMEWIN_SetFont(hItem,&GUI_FontHZ12);
	FRAMEWIN_SetTextAlign(hItem, GUI_TA_LEFT | GUI_TA_VCENTER);
	FRAMEWIN_AddCloseButton(hItem,FRAMEWIN_BUTTON_RIGHT,0);
	himage = WM_CreateWindowAsChild(5,18,230,272,hItem,WM_CF_SHOW|WM_CF_STAYONTOP,NULL,0);
//	WM_SelectWindow(himage);
//	GUI_SetBkColor(GUI_LIGHTGRAY);
//	GUI_Clear();
	...
	GUI_SetBkColor(GUI_LIGHTGRAY);
	GUI_Clear();
	FRAMEWIN_SetText(pMsg->hWin, pathbuffx);
				...
				case ID_TREEVIEW_0: // Notifications sent by 'Treeview'
					switch(NCode) {
						...
						// USER START (Optionally insert code for reacting on notification message)
							...
							{
								if(strcmp(pbuffx,pbufft)==0)
								{
									filesameflag = 1;
								}
								else
								{
									strcpy(pbuffx,pbufft);
									filesameflag = 0;
								}
